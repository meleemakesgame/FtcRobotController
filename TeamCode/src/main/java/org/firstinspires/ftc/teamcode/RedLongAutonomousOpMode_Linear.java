...
@Autonomous(name = "Robot: Basic Linear Autonomous OpMode Red Side Long", group = "Linear OpMode")
public class RedLongAutonomousOpMode_Linear extends LinearOpMode {
    @Override
